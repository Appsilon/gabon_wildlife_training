...
PATH_TO_MAIN = Path("/home/jupyter/gabon_wildlife_wwf_retrain")
PATH_TO_MODELS = PATH_TO_MAIN / "saved_models"
...
#     acc_02 = partial(accuracy_thresh, thresh=0.2)
    learn = cnn_learner(data, models.resnet50, metrics=[accuracy], callback_fns=[partial(WandbCallback)]).to_fp16()
